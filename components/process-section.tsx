...
export function ProcessSection() {
  return (
    <section
      id="process"
      className="scroll-mt-20 bg-background px-4 py-20 sm:px-6 sm:py-28 lg:px-8"
    >
      <div className="mx-auto max-w-6xl">
        <p className="reveal text-center text-xs font-medium uppercase tracking-[0.12em] text-teal">
          The Process
        </p>
        <h2 className="reveal mt-6 text-center font-heading text-[clamp(1.8rem,3vw,2.5rem)] font-extrabold text-foreground">
        ...
        <div className="relative mt-16 grid gap-12 sm:grid-cols-3 sm:gap-8">
          ...
          {steps.map((step, index) => (
            <div
              ...
              className="reveal relative border-t-2 border-teal py-8 px-6 text-center"
            >
        ...
        <div className="mt-12 mb-12 border-t border-[rgba(0,180,216,0.15)]" />
